...
# load data
h1 = numpy.loadtxt(datapath + '2017-06-10_DCH_C02_H1_O2_Sensitivity_strain_asd.txt') # G1902351
l1 = numpy.loadtxt(datapath + '2017-08-06_DCH_C02_L1_O2_Sensitivity_strain_asd.txt') # G1902347
v1 = numpy.loadtxt(datapath + 'Hrec_hoft_V1O2Repro2A_16384Hz.txt')
...
pyplot.grid()
fig.tight_layout()
pyplot.savefig(imgpath + "o2_strain.png")
